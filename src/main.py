...
PROJECT = {
  "code": "P17",
  "slug": "brazil-sdg-progress-radar",
  "title": "Brazil SDG Progress Radar",
  ...
  "kind": "sdg",
  "dataset": "IBGE SDG-style indicators sample",
  "source": "https://www.ibge.gov.br/estatisticas/multidominio/agenda-2030.html",
  "description": "Sustainable Development Goals radar chart lab comparing normalized regional indicators.",
  "concepts": [
    "radar chart",
    "normalization",
